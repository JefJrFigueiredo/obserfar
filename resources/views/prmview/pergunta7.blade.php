                ...
                <div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="{{ empty($p) ? '/prms/prm2' : '/prmview/confirmaEdicao' }}">
                        ...
                        <div class="form-group{{ $errors->has('prm') ? ' has-error' : '' }}">
							<label for="prm" class="col-md-9 control-label">EXISTE UM P.S QUE NÃO ESTEJA SENDO TRATADO?</label>
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<a href="/prms/prm1" class="btn btn-primary">
									<i class="fa fa-btn fa-user"></i>Sim
								</a>
								
								<a href="/prms/fimavaliacao" class="btn btn-primary">
